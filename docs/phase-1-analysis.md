## Phase 1 — Initial Operational Analysis

The first phase of the project used SQL to investigate operational questions within the original clinical trial recruitment and medical-record retrieval workflow.

These seven analyses established the project's analytical foundation by examining vendor performance, ROI conversion, medical-record turnaround times, patient progression, and operational bottlenecks.

As the analysis expanded, the findings raised broader questions about how the workflow itself was structured, how information moved between operational stages, and how centralized data could improve visibility and process management.
